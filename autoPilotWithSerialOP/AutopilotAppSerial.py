...
ard = Serial('/dev/cu.usbmodem14401', 9600) #update the serial op channel
...
while (cap.isOpened()):
    ...
    servoRotation = round(-smoothed_angle + 90, 1)
    print(servoRotation)
    srlCmnd = str(servoRotation) + "\r\n"
    ard.write(str.encode(srlCmnd))
